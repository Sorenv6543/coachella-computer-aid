...
- **[Homepage Blueprint](03-Website-Design/Homepage/)** — Detailed homepage sections and features
  - [[Homepage/Sections.md|Sections]] — Hero, Mission, Services, etc. (Navbar, Hero, Mission, Who We Help, Services, How It Works, Pay What You Can, CTA, Community Workshops & Footer now built)
